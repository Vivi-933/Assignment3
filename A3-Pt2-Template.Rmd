...
The data comes from NOAA Cyclone Data, 2022 Climate Change Opinion Survey, and World Happiness Report Score (from 2023 report). Hurricane Data contains record of tropical storms over the past 173 years, climate change opinion records how aware the population of various countries are about climate change, and happiness records various statistics about countries that are believed to impact the overall happiness of a country and gives them an overall happiness score.

In order to clean/tidy the data, we separated each differenttype of data entry into a unique column, filtered out irrelevant data entries, and removed outdated entries.
