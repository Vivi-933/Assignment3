...
In order to clean/tidy the data, we separated each different type of data entry into a unique column, filtered out irrelevant data entries, and removed outdated entries.
